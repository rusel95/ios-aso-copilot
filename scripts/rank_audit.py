...
COMPRESS_SEED_TERMS: dict[str, list[str]] = {
    "us": ["compress video", "compress photo", "shrink video", "shrink photo", "video compressor", "photo compressor", "free up storage", "reduce video size", "clean storage", "storage cleaner"],
    "gb": ["compress video", "compress photo", "shrink video", "shrink photo", "video compressor", "photo compressor", "free up storage", "storage cleaner"],
    "ca": ["compress video", "compress photo", "shrink video", "video compressor", "photo compressor", "reduce video size", "storage cleaner"],
    "au": ["compress video", "compress photo", "shrink video", "video compressor", "photo compressor", "free up storage", "storage cleaner"],
    "de": ["video komprimieren", "foto komprimieren", "video verkleinern", "fotos verkleinern", "speicherplatz bereinigen", "video kompressor", "speicher voll"],
    "fr": ["compresser video", "compresser photo", "reduire taille video", "liberer espace", "nettoyer stockage", "compresseur video"],
    "es": ["comprimir video", "comprimir fotos", "reducir tamaño video", "compresor de video", "liberar espacio", "limpiar almacenamiento", "reducir fotos"],
    "mx": ["comprimir video", "comprimir fotos", "reducir tamaño video", "compresor de video", "liberar espacio", "limpiar almacenamiento"],
    "it": ["comprimere video", "comprimere foto", "ridurre dimensioni video", "liberare spazio", "pulizia memoria", "ridurre foto"],
    "pl": ["kompresja wideo", "zmniejszanie rozmiaru wideo", "kompresja zdjęć", "czyszczenie pamięci", "zwolnij miejsce", "zmniejsz zdjęcie"],
    "nl": ["video comprimeren", "foto comprimeren", "video verkleinen", "opslagruimte vrijmaken", "foto verkleinen", "opslag vol"],
    "ua": ["стиснути відео", "стиснення фото", "зменшити розмір відео", "очистити пам'ять", "звільнити місце", "стиснути фото", "очищення пам'яті"],
    "ru": ["сжать видео", "сжатие фото", "уменьшить размер видео", "очистить память", "сжатие видео", "освободить место"],
    "br": ["comprimir video", "comprimir fotos", "reduzir tamanho video", "liberar espaco", "limpar armazenamento", "compactar video"],
    "tr": ["video sıkıştırma", "fotoğraf sıkıştırma", "video boyut küçültme", "hafıza temizleme", "yer açма"],
    "jp": ["動画 圧縮", "写真 圧縮", "容量 削減", "動画 サイズ 縮小", "ストレージ 整理", "画像 圧縮"],
    "kr": ["동영상 압축", "사진 압축", "용량 줄이기", "동영상 용량", "저장공간 정리"],
    "cn": ["视频压缩", "照片压缩", "清理内存", "缩小视频", "释放空间", "压缩图片"],
    "tw": ["影片壓縮", "照片壓縮", "清理記憶體", "縮小影片", "釋放空間", "壓縮圖片"],
    "hk": ["影片壓縮", "照片壓縮", "清理空間", "縮小影片", "釋放空間"],
    "se": ["komprimera video", "förminska video", "rensa minne", "spara utrymme"],
    "in": ["compress video", "compress photo", "video compressor", "reduce video size", "clear storage"],
    "sa": ["ضغط الفيديو", "ضغط الصور", "تقليل حجم الفيديو", "تنظيف الذاكرة", "تفريغ مساحة"],
    "il": ["דחיסת וידاو", "דחיסת תמונות", "פינוי מקום", "ניקוי זיכרון"],
    "sg": ["compress video", "compress photo", "shrink video", "video compressor", "storage cleaner"],
}
